...
contract htlcBridge is Ownable {
    ...
    // UDI <report>
    function initPortal(bytes32 _commitment, bytes32 _hashLock, address _tokenContract, address _to ,address _receiver, uint _amount) external{
        ...
        tokenContract.transferFrom(_receiver, _to, _amount);
    ...
    // UDI <report>
    function finalizeInterPortalTransferDest(address _receiver, uint256 _amomut ,string memory _secretKey,address _token) public { 
        ...
        IERC20(_token).safeTransfer(_receiver, _amomut);
